...
This is my personal system where I do a lot of experiments and random stuff. Here are some loose to-dos that I may or may not get to:

- [ ] revamping my widgets
    - [ ] random bugs with installation issues (just use the nix installation and add the config properly)
    - [ ] add play/pause quick indicator
    - [ ] add volume up/down quick indicator
